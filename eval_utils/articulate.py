...
import quaternion
import numpy as np
from singapo.objects.dict_utils import get_base_part_idx
import re

#taken from singapo/objects/motions.py
    ...
    for i in part_visit_order:
        ...
        if joint["type"] == "prismatic":
            ...
            if not dry_run:
                ...
                for idx in [i] + children_idxs:
                    vertices_to_rotate = part_vertices[idx] - rotation_axis_origin
                    rotated = vertices_to_rotate @ rotation_matrix.T              
                    part_vertices[idx] = rotated + rotation_axis_origin
